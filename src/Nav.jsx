...
function Nav({ onSearch }) {
  ...
  useEffect(() => {
    // Esta función se ejecuta cuando cambian los resultados de la búsqueda
    const updateResultsCount = (count) => {
      setResultsCount(count);
    };

    // Llama a la función de búsqueda con los criterios actuales y actualiza los resultados
